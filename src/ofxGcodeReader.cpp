...
//--------------------------------------------------------------
void ofxGcodeReader::readPathsFromGcode(std::string gcodeFileName) {
...
//--------------------------------------------------------------
void ofxGcodeReader::printPaths() {
...
//--------------------------------------------------------------
void ofxGcodeReader::cleanupPaths(float minSegmentLength) {
...
//--------------------------------------------------------------
void ofxGcodeReader::convertPathsToLines() {
...
//--------------------------------------------------------------
void ofxGcodeReader::convertPathsToMesh(float nozzleWidth, float layerThickness, int tubeResolution, int endCapResolution, float maxAngle) {
	// Clear any existing mesh data
	myMesh.clear();
...
//--------------------------------------------------------------
float3 ofxGcodeReader::getMidPos() {
...
//--------------------------------------------------------------
void ofxGcodeReader::draw() {
	myMesh.draw();
}

//--------------------------------------------------------------
void ofxGcodeReader::clearPaths() {
	if (myPaths.size() > 0) {
		for (unsigned int i = 0; i < myPaths.size(); i++) {
...
//--------------------------------------------------------------
void ofxGcodeReader::addCrossSection(float3 p, float3 d, float scaleFactor, float nozzleWidth, float layerThickness, int tubeResolution) {
...
//--------------------------------------------------------------
void ofxGcodeReader::addEndCap(float3 p, float3 d, float nozzleWidth, float layerThickness, int tubeResolution, int endCapResolution) {
